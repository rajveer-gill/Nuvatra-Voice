...
class Settings(BaseSettings):
    ...
    clerk_jwks_url: Optional[str] = Field(default=None, validation_alias="CLERK_JWKS_URL")
    clerk_issuer: Optional[str] = Field(default=None, validation_alias="CLERK_ISSUER")
    clerk_audience: Optional[str] = Field(default=None, validation_alias="CLERK_AUDIENCE")
