...
export function TransferTargetsSection({
  ...
  return (
    <motion.div
      className="md:col-span-2 rounded-2xl border border-violet-200/80 bg-gradient-to-br from-violet-50/90 via-white to-indigo-50/50 p-4 sm:p-5 shadow-sm"
    ...
    >
      ...
      >
        <motion.span
          className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-600 to-indigo-600 text-white shadow-lg shadow-violet-500/25"
        ...
        <motion.div className="min-w-0 flex-1" layout>
          <h3 className="text-base font-bold text-gray-900 flex flex-wrap items-center gap-2">
            ...
            <span className="inline-flex items-center gap-1 rounded-full bg-violet-100 px-2 py-0.5 text-xs font-semibold text-violet-800">
              ...
              Plan: {transfers.length}/{cap}
            </span>
          </h3>
          <p className="text-sm text-gray-600 mt-1">
            When a caller asks to speak with someone by name, the AI transfers only to numbers listed here — not your full team roster.
          </p>
        </motion.div>
      </motion.div>
